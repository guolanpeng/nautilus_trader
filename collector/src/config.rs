...
pub(crate) struct ExchangePlan {
    pub(crate) instruments: BTreeSet<String>,
    pub(crate) subscribe_book_deltas: bool,
    pub(crate) subscribe_quotes: bool,
    pub(crate) subscribe_trades: bool,
}
...
impl CollectorConfig {
    pub(crate) fn from_yaml_str(input: &str) -> Result<Self, serde_yaml::Error> {
